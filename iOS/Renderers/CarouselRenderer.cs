...
[assembly: ExportRenderer(typeof(CarouselPage), typeof(CarouselRenderer))]
namespace ParkPass.iOS
{
	public class CarouselRenderer : PageRenderer
	{
		...
		public override void ViewDidLoad()
		{
			...
			bool wrap = false;
			CGRect cg = new CGRect(0, 0, 300, 300);
			...
			carousel2 = new iCarousel(View.Bounds);
			carousel2.Type = iCarouselType.CoverFlow2;
			carousel2.DataSource = new CarouselDataSource();
			...
			carousel.GetValue = (sender, option, value) =>
			{
				...
				else if (option == iCarouselOption.Count)
				{
					return wrap ? 3 : 0;
				}
